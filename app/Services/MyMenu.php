    ...
    public function myMenu(): array
    {
        return [
            ...
            [
                ...
                'name' => 'Futsals',
                'icon' => 'fa fa-calendar',
                'is_active' => request()->routeIs('futsal*') ? 'active' : '',
                'conditions' => [
                    [
                        'type' => 'or',
                        'condition' => auth()->user()->can('view-any', App\Models\Admin\Futsal::class),
                    ],
                    [
                        'type' => 'or',
                        'condition' => auth()->user()->can('create', App\Models\Admin\Futsal::class),
                    ],
                ],
                'children' => $this->indexCreateChildren('futsal', App\Models\Admin\Futsal::class)
            ],
            [
                'type' => 'breaker',
                'name' => 'Futsal',
